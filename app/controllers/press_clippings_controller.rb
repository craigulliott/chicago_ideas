class PressClippingsController < ApplicationController
  ...
  def index
     ...
     @page_title = "News"
     @meta_data = {:page_title => "CIW News", :og_image => "/assets/application/logo.jpg", :og_title => "News | Chicago Ideas Week", :og_type => "website", :og_desc => "Chicago Ideas Week (CIW) is about the sharing of ideas, inspiring action and igniting change to positively impact our world. People who come to CIW are artists, engineers, technologists, inventors, scientists, musicians, economists, explorers-and, well...just innately passionate."}
   end
