class EventsController < ApplicationController
  ...
  def index
    ...
    @meta_data = {:page_title => "CIW Events", :og_image => "/assets/application/temp/speaker_landing_banner.jpg", :og_title => "CIW Events | Chicago Ideas Week", :og_type => "website", :og_desc => "Chicago Ideas Week (CIW) is about the sharing of ideas, inspiring action and igniting change to positively impact our world. People who come to CIW are artists, engineers, technologists, inventors, scientists, musicians, economists, explorers-and, well...just innately passionate."}
  end
  ...
  def affiliate_event
    ...
    @meta_data = {:page_title => "Affiliate Events", :og_image => "/assets/application/affilliate_events_banner.jpg", :og_title => "Affiliate Events | Chicago Ideas Week", :og_type => "website", :og_desc => "Chicago Ideas Week (CIW) is about the sharing of ideas, inspiring action and igniting change to positively impact our world. People who come to CIW are artists, engineers, technologists, inventors, scientists, musicians, economists, explorers-and, well...just innately passionate."}
  end
