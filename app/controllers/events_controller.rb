class EventsController < ApplicationController
  ...
  def show
    ...
    @partnerprograms = EventBrand.find_by_name("Partner Program").archived.events
  ...
  def labs
   @labs = EventBrand.find_by_name("Lab").events.archived.order('name ASC')
